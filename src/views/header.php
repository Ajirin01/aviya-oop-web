...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="src/assets/img/aviya-logo.jpg" type="image/x-icon">
    ...
    <!-- price picker slider -->
    <link rel="stylesheet" type="text/css" href="src/assets/css/nouislider.css">
    <!-- Fancybox slider -->
    <link rel="stylesheet" href="src/assets/css/jquery.fancybox.css" type="text/css" media="screen" /> 
    <!-- Theme color -->
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/62da030554f06e12d88abb7d/1g8hpnkk3';
        s1.charset='UTF-8';
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- Text based logo -->
           ...
           <!-- Image based logo -->
           <a class="navbar-brand aa-logo-img" href="/"><img  style="border: 3px solid rgb(185, 181, 181)" src="src/assets/img/aviya-logo.jpg" alt="logo"></a>
        </div>
